    ...
    if(i===sliders-1){
      content.push(
        <div
          ...
          key={"slide-"+(i+1)}
        >
          <div className="-mb-8 text-4xl font-serif font-light mt-5" style={{textShadow: '1px 1px 2px gray'}}>Фермерское Мясо</div>
...
function Meat(props) {
  ...
  const filteredProducts = products.filter((o) => o.type_id === 2);
