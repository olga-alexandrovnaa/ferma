...
function Basket() {
  return (
    <>
      <div style = {{height: "80vh", margin: "", background: "rgba(166, 182, 198, 0.44)"}}>
      <div className="text-4xl pt-8 font-serif font-light text-center" style={{textShadow: '1px 1px 2px gray'}}>Корзина</div>

      <div className="container mx-auto max-w-lg h-screen flex flex-col space-y-4 justify-center items-center">
        <div className="bg-white w-full flex items-center p-2 rounded-xl shadow border">
          <div className="flex p-3">
            <div className="font-semibold  pt-4 text-gray-700">
                Мясо бройлера 1кг
            </div>
            <div className="">
